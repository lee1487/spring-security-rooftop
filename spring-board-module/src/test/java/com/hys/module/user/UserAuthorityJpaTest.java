...
import com.hys.module.user.repository.UserRepository;
import com.hys.module.user.service.PrincipalDetailsService;
import com.hys.module.user.service.UserService;
import com.hys.module.user.vo.PrincipalDetails;
...
public class UserAuthorityJpaTest {
	...
	void test_2() {
		...
		User savedUser = userService.findUser(user1.getId()).get();
	...
	void test_3() {
		...
		userService.addAuthority(user1.getId(), "ROLE_ADMIN");
